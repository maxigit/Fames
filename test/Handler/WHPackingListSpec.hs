...
appSpec = withAppWipe BypassAuth $ do
  describe "@current upload packing list" $ do
    describe "#valid" $ do
      it "@fail validates simple boxes" $ do
        validatePLSheet 200 [st|Style No .,color,QTY,C/NO,,,CTN,QTY/CTN,QTY,Length,Width,Height,CBM/CTN,N. W./CTN,G.W./CTN,CBM,N.W,"G.W.(KGS)"
T-shirt,Black,24,13,,16,4,6,24,79,X,45,X,38,0.14,0.3,1.51,0.54,1.2,6.04
Cardigan,Red,24,1124,,1127,4,6,24,41,X,39,X,76,0.12,0.4,1.9,0.49,0,0|]
      it "validates mixed box" $ do
        validatePLSheet 200 [st|Style No .,color,QTY,C/NO,,,CTN,QTY/CTN,QTY,Length,Width,Height,CBM/CTN,N. W./CTN,G.W./CTN,CBM,N.W,"G.W.(KGS)"
T-shirt,Black,24,13,,13,1,36,36,79,X,45,X,38,0.14,0.3,1.51,0.54,1.2,6.04
Cardigan,Red,12,,,,,1,,,X,,X,,0.12,0.4,1.9,0.49,0,0|]
      it "many orders " $ do
        validatePLSheet 200 [st|Style No .,color,QTY,C/NO,,,CTN,QTY/CTN,QTY,Length,Width,Height,CBM/CTN,N. W./CTN,G.W./CTN,CBM,N.W,"G.W.(KGS)"
T-shirt,Black,24,13,,16,4,6,24,79,X,45,X,38,0.14,0.3,1.51,0.54,1.2,6.04
Container C2,,,,,,,,,,,,,,,,,,,
