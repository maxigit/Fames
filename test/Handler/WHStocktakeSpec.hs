  ...
  request $ do
    ...
    case overrideM of
      ...
      Just over -> do
        ...
        addPostParam "f6" $ if over then "yes" else "no"
...
appSpec = withAppWipe BypassAuth $ before_ (pendingWith "Need shelf and operation validatan ") do
  describe "@Stocktake upload stocktake" $ do
    ...
    describe "upload" $ do
      it "parses correctly a correct file" $ do
        logAsAdmin
        postSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                            |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                            |]

      it "saves stocktakes" $ do
        saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                            |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                            |]
      ...
      it "doesn't save twice the same file" $ do
        saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                            |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                            |]
        saveSTSheet 422 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                            |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                            |]
...
-- |]
--         saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
-- t-shirt,black,120,shelf-2,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
-- |]
--         barcodes <- findBarcodes 
--         let types = barcodes :: [Text]
--         liftIO $ barcodes `shouldBe`  ["ST16NV00399X"]
    ...
    describe "process blanks" $ do
      it "fills barcode prefix" $ do
        postSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                            |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                            |t-shirt,red,120,shelf-1,400E,34,20,17,2016/11/10,Jack,,B
                            |]
      ...
      it "fills barcode sequence" $ do
        postSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                            |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                            |t-shirt,red,120,shelf-1,,34,20,17,2016/11/10,Jack,,B
                            |t-shirt,red,120,shelf-1,00401L,34,20,17,2016/11/10,Jack,,B
                            |]
        mapM (htmlAnyContain "table td.stocktakeBarcode")
      ...
      it "groups mixed colours with the same barcode" $ do
        postSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                            |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                            |t-shirt,red,120,shelf-1,-,,,,,Jack,,B
                            |]
...
--         htmlCount "table. td.stocktakeBarcode" 2
    ...
    describe "overriding existing stocktake" $ do
      it "Creates a new stocktake item if needed" $ do
        updateSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |]
      ...
      it "Updates the stocktake value" $ do
        ...
        updateSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,red,17,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |]
        stockTake <- runDB $ getBy (UniqueSB "ST16NV00399X" 1)
    ...
    describe "validation" $ do
      it "detects incorrect barcode on the first line" $ do
          postSTSheet 422 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,black,120,shelf-1,ST16NV00399Z,34,20,17,2016/11/10,Jack,,B
                              |]  
      ...
      it "detects incorrect barcode" $ do
          postSTSheet 422 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |t-shirt,red,120,shelf-1,ST16NV00400X,34,20,17,2016/11/10,Jack,,B
                              |]  
      ...
      it "detects incorrect partial barcode" $ do
          postSTSheet 422 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |t-shirt,red,120,shelf-1,400X,34,20,17,2016/11/10,Jack,,B
                              |]  
      ...
      it "detects incorrect barcode sequence" $ do
          postSTSheet 422 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |t-shirt,red,120,shelf-1,,34,20,17,2016/11/10,Jack,,B
                              |t-shirt,red,120,shelf-1,00400E,34,20,17,2016/11/10,Jack,,B
                              |]  
      ...
      it "checks same barcode not twice in a row" $ do
        postSTSheet 422 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |t-shirt,red,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |]
  ...
  describe "null quantity " $ do
    ...
    it "breaks barcode sequences" $ do
          postSTSheet 422 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |t-shirt,red,120,shelf-1,,34,20,17,2016/11/10,Jack,,B
                              |t-shirt,red,0,,,,,,2016/11/10,Jack,,B
                              |]  
    ...
    it "accepts 0 quantity in grouped box" $ do
        postSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |t-shirt,red,0,,,,,,,Jack,,B
                              |t-shirt,black,120,shelf-1,ST16NV00400E,34,20,17,2016/11/10,Jack,,B
                              |]
    ...
    describe "quick take" $ do
      it "doesn't generate boxes" $ do
        postSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,black,120,,0,,,,2017/11/10,Jack,,B
                              |]
    ...
    describe "barcode lookup" $ do
      it "find content from barcode" $ do
        saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |,red,120,,-,,,,2016/11/10,Jack,,B
                              |]
        postSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,,,shelf-2,ST16NV00399X,,,,2016/11/10,Jack,,B
                              |]
      ...
      it "updates boxtake history" $ do
        ...
        saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt,,,shelf-2,ST16NV00399X,,,,2017/05/19,Jack,,B
                              |]
    ...
    describe "invalidates previous take" $ do
      ...
      context "full take" $ do
        it "does invalidate previous boxes" $ do
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirtA,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |]
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirtA,black,120,shelf-1,ST16NV00400E,34,20,17,2017/05/19,Jack,,B
                              |]
        ...
        it "does invalidate previous stocktakes" $ do
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirtB,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |]
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirtB,black,120,shelf-1,ST16NV00400E,34,20,17,2017/05/19,Jack,,B
                              |]
      ...
      context "zero take" $ do
        it "does invalidate previous boxes" $ do
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirtC,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |]
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirtC,black,0,,,,,,2017/05/19,Jack,,B
                              |]
        ...
        it "does invalidate previous stocktakes" $ do
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirtD,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |]
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirtD,black,0,,,,,,2017/05/19,Jack,,B
                              |]
    ...
    -- stocktakes older than exisiting should invalidates anything
      context "full take" $ do
        it "does NOT invalidate previous boxes" $ do
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt#11,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |]
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt#11,black,120,shelf-1,ST16NV00400E,34,20,17,2015/05/19,Jack,,B
                              |]
        ...
        it "does NOT invalidate previous stocktakes" $ do
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt#12,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |]
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt#12,black,120,shelf-1,ST16NV00400E,34,20,17,2015/05/19,Jack,,B
                              |]
      ...
      context "quick take" $ do
        it "does not invalidate previous boxtakes" $ do
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              ...
                              |]
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirtD,black,7,,0,,,,2017/05/19,Jack,,B
                              |]
      ...
      context "zero take" $ do
        it "does NOT invalidate previous boxes" $ do
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt#13,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |]
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt#13,black,0,,,,,,2015/05/19,Jack,,B
                              |]
        ...
        it "does NOT invalidate previous stocktakes" $ do
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt#14,black,120,shelf-1,ST16NV00399X,34,20,17,2016/11/10,Jack,,B
                              |]
          saveSTSheet 200 [sbt|Style,Colour,Quantity,Location,Barcode Number,Length,Width,Height,Date Checked,Operator,Comment,Batch
                              |t-shirt#14,black,0,,,,,,2015/05/19,Jack,,B
                              |]
