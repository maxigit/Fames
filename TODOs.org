...
** Today [0/4] 
   - [ ] Update Form
     ...
     - [ ] One line for rupture
     - [ ] sensible Default
   - [ ] Replace supplier /customer with supplierCustmenr Either Int Int
   - [ ] Make generic map level Map (Dynamic) (Either Map Value)
     - [ ] with probably custom Dynamic type as key
   - [ ] load customer/supplier
** previous [2/4] 
