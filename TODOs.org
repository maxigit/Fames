* TODO Web status  price
- [ ] pass salesTypes as argument and use it to count column
- [ ] don't fail if price table doesn't existing
- [ ] implement diff and create webprice from FA Prices list
and set it to base
- [ ] filter inactive price list?
