...
- [ ] use CURL lib to generate
  - [ ] generate StockAdjustment FA Object - which mapp to 
  - [ ] generate StockRename
  - [ ] generate Item Transfert Object - no persistence
- [ ] Stock adjustmen
- [ ] item transfer
...
- [ ] Adjust quantity to not generate negative stock
  - [ ] display it along old original quantity (textcart comment ?)
  - [ ] find way to calculate actual quantities to adjustment
    - [ ] just floor quantity to 0
    - [ ] OR see which adjustment have been made since
    - [ ] OR see all movement done since (or just compare QOH now)
