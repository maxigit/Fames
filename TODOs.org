...
** Today [8/21] 
   ...
   - [ ]  rename table to summary
     - [ ]  readd sliding year in options or is period enough ?
   - [ ] Adjustment wrond way ?
   - [-]  Add formating function (% or normal, or forbidden)
     - [-] percentage column, total, row
       - [X] total above ?
       - [ ] column
       - [ ] use different scale for %
       - [ ] Add rank
